		...
		<div class="col-md-12 bookinfo" id="001">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೨ನೇ ಆವೃತ್ತಿ ⁘ ೧೬೮ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="002">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೪ನೇ ಆವೃತ್ತಿ ⁘ ೬೩ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="003">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೪ನೇ ಆವೃತ್ತಿ ⁘ ೩೩೦ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="004">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೩ನೇ ಆವೃತ್ತಿ ⁘ ೪೮೦ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="005">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೩ನೇ ಆವೃತ್ತಿ ⁘ ೫೨೫ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="006">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೧೪ ಆವೃತ್ತಿ ⁘ ೪೦೬ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="007">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೭ನೇ ಆವೃತ್ತಿ ⁘ ೪೨೪ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="008">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೩ನೇ ಆವೃತ್ತಿ ⁘ ೧೮೪ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="009">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೨ನೇ ಆವೃತ್ತಿ ⁘ ೧೦೪ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="010">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೧ನೇ ಆವೃತ್ತಿ ⁘ ೧೬೫ ಪುಟಗಳು</p>
					<p class="description">
		...
		<div class="col-md-12 bookinfo" id="011">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<p class="edition">೨ನೇ ಆವೃತ್ತಿ ⁘ ೩೪ ಪುಟಗಳು</p>
					<p class="description">
